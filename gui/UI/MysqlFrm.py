...
import mysql_db_conf as mysql_conf
...
conn = mysql.connect(**mysql_conf.dbConfig)
cursor = conn.cursor()
GUIDB = "GuiDBS"
#try:
...
class MysqlFrame(object):
    ...
    def create_frm_top(self):
        ...
        self.frm_middle = pytk.PyLabelFrame(self.frm_top)
        ...
        self.frm_middle.pack(fill="both", expand=1, padx=2, pady=5, side=tk.RIGHT)
