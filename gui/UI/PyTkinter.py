...
if __name__ == '__main__':
    ...
    pytk.PyButton(root, text="1234").pack()
    pytk.PyLabel(root, text="123").pack()
    pytk.PyCheckbutton(root, text="123").pack()
    pytk.PyEntry(root).pack()
    pytk.PyText(root, height=2, width=20).pack()
    listbox_0 = pytk.PyListbox(root, height=2)
    listbox_0.pack()
    for i in range(2):
    ...
    tab_ctr = pytk.PyNotebook(root)
    tab1 = pytk.PyFrame(tab_ctr)
    tab_ctr.add(tab1, text="Tab 1")
    tab_ctr.pack(expand=1, fill="both")
